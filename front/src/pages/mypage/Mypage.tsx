...
function UsageCard() {
  const progressWidth = `${(USAGE_CARD.remainingCount / USAGE_CARD.totalCount) * 100}%`;
    ...
    <div className="rounded-[20px] bg-greyscale-bg-100 p-5">
      <div className="mb-3 flex items-center gap-0.5">
        <p className="text-subtitle3 text-greyscale-text-title-800">
          남은 횟수{' '}
          <span className="text-primary-500">{USAGE_CARD.remainingCount}</span>
          <span className="text-greyscale-text-disabled-500">
            /{USAGE_CARD.totalCount}회
          </span>
        </p>
...
export default function Mypage() {
  ...
  return (
    <div className="min-h-screen bg-greyscale-bg-50 pt-[6px]">
      <AppBar variant="name-right-chip" title="김지성" chipLabel="계정 정보" />
